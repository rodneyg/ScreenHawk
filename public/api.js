...
var OPENAI_API_KEY = 'your-openai-api-key-here'; // Replace with your actual OpenAI API key
var OPENAI_API_URL = 'https://api.openai.com/v1/chat/completions';
function sendToOpenAI(prompt, screenshot) {
    return __awaiter(this, void 0, void 0, function () {
        var base64Image, response, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    base64Image = screenshot.replace(/^data:image\/(png|jpeg|jpg);base64,/, '');
                    return [4 /*yield*/, axios_1.default.post(OPENAI_API_URL, {
